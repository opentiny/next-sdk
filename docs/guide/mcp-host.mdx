...
2. 在 Windsurf 中配置 MCP Servers

![](../assets/images/windsurf/2.png)

3. 配置 `mcp_config.json` 文件，格式如图

![](../assets/images/windsurf/3.png)

4. 点击 Refresh 会出现我们的 MCP Servers
...
2. 在 Trae 使用快捷键 Ctrl + U 弹出 AI 对话框，点击设置按钮进行设置 MCP Server
...
1. 进入 Dify 官网，登录后点击打开网页版并进行登录注册
...
1. 进入 [Coze](https://space.coze.cn/) 官网，登录后点击打开网页版
