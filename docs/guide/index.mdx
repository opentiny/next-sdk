...
**NEXT SDK** 支持通过各种主流 MCP Host 对智能应用进行操控，支持主流大模型，支持主流 AI 对话框，支持 [ Vue ](https://cn.vuejs.org/)、[ React ](https://react.dev/)、[Angular](https://www.angular.cn/) 主流前端框架。
...
完成以上步骤，你的 Web 应用就变成了一个智能应用，就可以被 AI 操控，你可以[通过各类 MCP Host 操控智能应用](guide/mcp-host)。
