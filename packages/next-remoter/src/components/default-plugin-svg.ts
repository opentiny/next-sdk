// 获取 SVG 图像的源码
const svgString = `
<svg data-v-e1c9ac5c="" width="1em" height="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs>
        <clipPath id="clip657_188316">
            <rect id="接口调用执行 (1)" width="20.000000" height="20.000000" transform="translate(20.000000 0.000000) rotate(90.000000)" fill="white" fill-opacity="0"></rect>
        </clipPath>
    </defs>
    <g clip-path="url(#clip657_188316)">
        <path id="path" d="M11.87 17.5L11.87 2.53C11.87 2.19 12.15 1.91 12.49 1.91C12.84 1.91 13.12 2.19 13.12 2.53L13.12 17.5C13.12 17.84 12.84 18.12 12.49 18.12C12.15 18.12 11.87 17.84 11.87 17.5Z" fill="currentColor" fill-opacity="1.000000" fill-rule="nonzero"></path>
